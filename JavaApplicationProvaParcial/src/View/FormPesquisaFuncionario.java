 ...
 * @author Alexandre
 */
public class FormPesquisaFuncionario extends javax.swing.JInternalFrame {
    ...
    private void tabDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabDadosMouseClicked
        ...
        if (evt.getClickCount() == 2){
            ...
            FormCadastroFuncionario o = new FormCadastroFuncionario(id);
    ...
    private void txtNomeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNomeKeyReleased
        //if (evt.getKeyCode() == KeyEvent.VK_ENTER){ //PARA quando apenas o enter pesquisar
            ...
            if(nome.isEmpty()){
                ...
                preencherTabela(new FuncionarioDAO().listarFuncionario());
            }else{
                //pesquisar pelo nome
                preencherTabela(
                    new FuncionarioDAO().pesquisarPorNomeFuncionario(nome)
                );
            }
            //}end do keyEvent
...
private void configurarForm(){
        this.setTitle("Pesquisa de funcionario");
                    ...
                    m.addRow(new Object[]
                        {
                            ...
                            new EmpresaDAO().pesquisarPorIdEmpresa(
                                    Integer.toString(obj.getId_empresa())
                            ),
                            obj.getNome(),
                            obj.getEmail(),
                            obj.getTelefone(),
